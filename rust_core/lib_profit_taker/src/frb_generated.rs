...
pub(crate) const FLUTTER_RUST_BRIDGE_CODEGEN_CONTENT_HASH: i32 = -98974304;
...
fn pde_ffi_dispatcher_sync_impl(
    ...
    match func_id {
        ...
        3 => wire__crate__api__delete_run_from_db_impl(ptr, rust_vec_len, data_len),
        4 => wire__crate__api__get_earliest_run_id_impl(ptr, rust_vec_len, data_len),
        5 => wire__crate__api__get_latest_run_id_impl(ptr, rust_vec_len, data_len),
        6 => wire__crate__api__get_next_run_id_impl(ptr, rust_vec_len, data_len),
        7 => wire__crate__api__get_pretty_printed_run_impl(ptr, rust_vec_len, data_len),
        8 => wire__crate__api__get_previous_run_id_impl(ptr, rust_vec_len, data_len),
        9 => wire__crate__api__get_run_from_db_impl(ptr, rust_vec_len, data_len),
        11 => wire__crate__api__initialize_db_impl(ptr, rust_vec_len, data_len),
        12 => wire__crate__api__initialize_parser_wrapper_impl(ptr, rust_vec_len, data_len),
        13 => wire__crate__api__mark_run_as_favorite_impl(ptr, rust_vec_len, data_len),
        14 => wire__crate__api__remove_run_from_favorites_impl(ptr, rust_vec_len, data_len),
        15 => wire__crate__api__update_run_name_impl(ptr, rust_vec_len, data_len),
        _ => unreachable!(),
    }
}

      ...
      child: Container(
        ...
        child: Column(
          ...
          children: <Widget>[
            ...
            const SizedBox(height: 20),
            _buildNavItem(context, AppConstants.favoritesGreyIcon,
                AppConstants.favoritesSelectedIcon, 2),
            const SizedBox(height: 20),
            _buildNavItem(context, AppConstants.analyticsGreyIcon,
                AppConstants.analyticsSelectedIcon, 3),
            const SizedBox(height: 20),
            _buildNavItem(context, AppConstants.settingsGreyIcon,
                AppConstants.settingsSelectedIcon, 4),
          ],
        ),
      ),
    );
